	...
	function green_system_about_us_page_fields(){
		Container::make( 'post_meta', __('Головний екран') )
		         ...
		         ->add_fields( array(
			         ...
			         Field::make_text('green_system_about_us_main_screen_subtitle'.green_system_lang_prefix(), 'Підзаголовок'),
			         Field::make_image('green_system_about_us_main_screen_image'.green_system_lang_prefix(), 'Зображення')
		         ));

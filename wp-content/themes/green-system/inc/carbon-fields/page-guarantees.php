<?php
	...
	function green_system_guarantees_page_fields(){
		Container::make( 'post_meta', __('Головний екран') )
		         ...
		         ->add_fields( array(
			         Field::make_text('green_system_guarantees_main_screen_title'.green_system_lang_prefix(), 'Головний заголовок'),
			         Field::make_text('green_system_guarantees_main_screen_subtitle'.green_system_lang_prefix(), 'Підзаголовок'),

<?php
	...
	add_filter( 'login_headertext', 'green_system_change_login_logo_text' );

	function green_system_change_login_logo_text( $text ) {
		return 'GREEN SYSTEM';
	}

	add_action( 'login_head', 'green_system_no_login_logo' );

	function green_system_no_login_logo() {
		echo '<style>
		#login h1 a {
	...
	add_filter( 'login_headerurl', 'green_system_login_link_to_website' );

	function green_system_login_link_to_website( $url ) {
		return site_url();
	}
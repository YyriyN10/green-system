...
<?php get_template_part('template-parts/block-breadcrumbs');?>
  ...
  <?php
      $serviceWhatYouGetBlockTitle = carbon_get_post_meta(get_the_ID(), 'green_system_service_what_you_get_block_title'.green_system_lang_prefix());
	    $serviceWhatYouGetList = carbon_get_post_meta(get_the_ID(), 'green_system_service_what_you_get_list'.green_system_lang_prefix());
	    $serviceWhatYouGetImage = carbon_get_post_meta(get_the_ID(), 'green_system_service_what_you_get_image'.green_system_lang_prefix());

      if( $serviceWhatYouGetBlockTitle && $serviceWhatYouGetList && $serviceWhatYouGetImage ):?>
      <!-- Що отримуєте якщо будуєте з нами -->
      <section class="service-what-you-get service-block indent-bottom-middle animation-tracking">
        <div class="container">
          <div class="row">
            <div class="text-content col-lg-6">
              <h2 class="block-title small-title first-up"><?php echo $serviceWhatYouGetBlockTitle;?></h2>
              <ul class="get-list second-up">
                <?php foreach( $serviceWhatYouGetList as $item ):?>
                  <li class="item">
                    <span class="icon">
            ...
            <div class="pic-wrapper col-lg-5 offset-lg-1 col-sm-8 offset-sm-4 col-10 offset-2 third-up">
              <div class="pic">
                <img
                   class="lazy"
                   data-src="<?php echo wp_get_attachment_image_src($serviceWhatYouGetImage, 'full')[0];?>"
                   alt="<?php echo get_post_meta($serviceWhatYouGetImage, '_wp_attachment_image_alt', TRUE);?>"
                >
              </div>
...
<?php
	$serviceOwnCenterBlockTitle = carbon_get_post_meta(get_the_ID(), 'green_system_service_own_center_block_title'.green_system_lang_prefix());
	$serviceOwnCenterText = carbon_get_post_meta(get_the_ID(), 'green_system_service_own_center_text'.green_system_lang_prefix());
	$serviceOwnCenterImage = carbon_get_post_meta(get_the_ID(), 'green_system_service_own_center_image'.green_system_lang_prefix());

	if( $serviceOwnCenterBlockTitle && $serviceOwnCenterText && $serviceOwnCenterImage ):?>
    <!-- Власний сервісний центр -->
    <section class="own-center service-block indent-bottom-big animation-tracking">
      <div class="container">
        <div class="row">
          <div class="text-content col-lg-6 ">
            <h2 class="block-title small-title first-up"><?php echo $serviceOwnCenterBlockTitle;?></h2>
            <div class="text second-up"><?php echo wpautop($serviceOwnCenterText);?></div>
          </div>
          <div class="pic-wrapper col-lg-5 offset-lg-1 col-sm-8 offset-sm-4 col-10 offset-2 third-up">
            <div class="pic">
              <img
                  class="lazy"
                  data-src="<?php echo wp_get_attachment_image_src($serviceOwnCenterImage, 'full')[0];?>"
                  alt="<?php echo get_post_meta($serviceOwnCenterImage, '_wp_attachment_image_alt', TRUE);?>"
              >
            </div>
            <svg class="dots-pic" width="348" height="204" viewBox="0 0 348 204" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="6" cy="6" r="2" fill="#599C12"/>
...
<?php
	$contactFormTitle = carbon_get_post_meta(get_the_ID(), 'green_system_service_form_block_title'.green_system_lang_prefix());
	$contactFormText = carbon_get_post_meta(get_the_ID(), 'green_system_service_form_text'.green_system_lang_prefix());
	$contactFormKey = carbon_get_post_meta(get_the_ID(), 'green_system_service_form_kay'.green_system_lang_prefix());
